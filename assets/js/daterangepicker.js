...
(function(root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
            ...
            '<input id="start_date" class="input-mini" type="text" name="daterangepicker_start" value="" />' +
            '</div>' +
            '<div class="daterangepicker_end_input">' +
            '<label for="daterangepicker_end"></label>' +
            '<input id="end_date" class="input-mini" type="text" name="daterangepicker_end" value="" />' +
            '</div>' +
            '<button class="applyBtn" id="date_range_picker" onclick="date_range();"  disabled="disabled"></button>&nbsp;' +
